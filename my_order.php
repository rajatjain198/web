...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        ...
        <div class="row">
            <div class="col-sm-9">
                <?php 
                    foreach ($product->getCart($_SESSION['user_id'],'orders') as $item) : 
                        echo "<br>Order Status:    ".$item['order_status'];
                        echo "<br>Payment Status:    ".$item['payment_status']."&nbsp; Payment Type:  ".$item['payment_type']."&nbsp; Total Amount: ".$item['total_price'];
                        echo "<br>Delivery Address:    ".$item['address']."&nbsp;".$item['city']."&nbsp;".$item['state']."&nbsp;".$item['pincode'];
                        foreach($product->getOrder($item['id'],'order_detail') as $item):
                            echo "<br>Quantity:    ".$item['qty'];
