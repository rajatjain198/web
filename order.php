...
$res=mysqli_query($con,$sql);
    ...
    $result=mysqli_query($con,"INSERT INTO order_detail(order_id,product_id,qty,price) VALUES('$order_id','$item_id','$qty','$total_price')");
        ...
        <div class="row m-0">
            <div class="col-lg-8 offset-lg-2">
                ...
                <div class="d-flex justify-content-center">
                    <form action="order.php" method="post" enctype="multipart/form-data" id="reg-form">
                    <div class="form-row my-4">
                        ...
                        <div class="form-row">
                            ...
                            <input type="hidden" name="total_price" value="<?php echo $_POST['total_price']*$_POST['qty'];?>">
                        </div>
                        <div class="form-row my-4">
                        <div class="col">
                        ...
                        <input type="radio" name="payment" id="payu" class="form-control" value="payu" required>
                                <label for="upi" class="form-radio-label font-ubuntu text-black-50">Payment PayU</label> <br>   
                        </div>
