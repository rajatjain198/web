...
<section id="cart" class="py-3 mb-5">
    <div class="container-fluid w-75">
        ...
        <div class="row">
            <div class="col-sm-9">
                <?php
                foreach ($product->getCart($_SESSION['user_id'],'wishlist') as $item) :
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger mr-3 pr-3 border-right">Delete</button>
                                    </form>

                                    <form method="post">
                                        <input type="hidden" value="<?php echo $item['item_id'] ?? 0; ?>" name="item_id">
                                        <button type="submit" name="cart-submit" class="btn font-baloo text-dark">Add to Cart</button>
                                    </form>
